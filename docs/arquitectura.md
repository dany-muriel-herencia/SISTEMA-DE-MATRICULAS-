...
La identidad se obtiene de una sesión aleatoria persistida y del usuario actual en la base; los roles enviados por el cliente no se consideran. Las operaciones transaccionales residen en el repositorio de matrícula. El frontend actual es un diagnóstico de conexión, no una aplicación completa de gestión académica.
